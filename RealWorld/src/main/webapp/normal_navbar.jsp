	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="#"><span
					class="fa fa-desktop"></span> Learn Coding <span class="sr-only">(current)</span>
			</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="#"><span
					class="fa fa-user"></span> Contact us.</a></li>
			<li class="nav-item"><a class="nav-link " href="login_page.jsp"><span
					class="fa fa-power-off fa-spin"></span> Login</a></li>
